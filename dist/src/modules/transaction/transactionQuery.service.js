...
let TransactionQueryService = TransactionQueryService_1 = class TransactionQueryService {
    constructor(vehicleRepository) {
        this.vehicleRepository = vehicleRepository;
        this.logger = new common_1.Logger(TransactionQueryService_1.name);
    }
    async findVehicleCountByModelAndAggregator() {
        try {
            ...
            this.logger.error(`[TransactionQueryService] [findVehicleCountByModelAndAggregator] Error: ${error.message}`);
    ...
    async findVehicleCountByAggregatorAndModel() {
        try {
            ...
            this.logger.error(`[VehicleService] [findVehicleCountByAggregatorAndModel] Error: ${error.message}`);
            throw new common_1.InternalServerErrorException(error.message);
        }
    }
    async findVehicleCountByOwnerAndAggregator() {
        try {
            ...
            this.logger.error(`[VehicleService] [findVehicleCountByOwnerAndAggregator] Error: ${error.message}`);
            throw new common_1.InternalServerErrorException(error.message);
        }
    }
    async findVehicleCountByAggregatorAndCategory() {
        try {
            ...
            this.logger.error(`[VehicleService] [findVehicleCountByAggregatorAndCategory] Error: ${error.message}`);
            throw new common_1.InternalServerErrorException(error.message);
        }
    }
    async findVehicleCountByAggregatorEmiratesAndCategory() {
        try {
            ...
            this.logger.error(`[VehicleService] [findVehicleCountByAggregatorEmiratesAndCategory] Error: ${error.message}`);
            throw new common_1.InternalServerErrorException(error.message);
        }
    }
    async findVehicleCountByEmiratesAndCategory() {
        try {
            ...
            this.logger.error(`[VehicleService] [findVehicleCountByEmiratesAndCategoryFuel] Error: ${error.message}`);
            throw new common_1.InternalServerErrorException(error.message);
        }
    }
    async findVehicleCountByEmiratesAndOwnedBy() {
        try {
            ...
            this.logger.error(`[VehicleService] [findVehicleCountByEmiratesAndOwnedBy] Error: ${error.message}`);
            throw new common_1.InternalServerErrorException(error.message);
        }
    }
    async findCategoryOperationByEmirates() {
        try {
            ...
            this.logger.error(`[VehicleService] [findCategoryOperationByEmirates] Error: ${error.message}`);
            throw new common_1.InternalServerErrorException(error.message);
        }
    }
    async findEmiratesCategoryCount() {
        try {
            ...
            this.logger.error(`[VehicleService] [findEmiratesCategoryCount] Error: ${error.message}`);
            throw new common_1.InternalServerErrorException(error.message);
        }
    }
    async findExpiryStatus() {
        try {
          ...
          END AS status`,
            ...
            this.logger.error(`[VehicleService] [findExpiryStatus] Error: ${error.message}`);
            throw new common_1.InternalServerErrorException(error.message);
        }
    }
};
exports.TransactionQueryService = TransactionQueryService;
exports.TransactionQueryService = TransactionQueryService = TransactionQueryService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_2.InjectRepository)(vehical_entity_1.Vehicle)),
    __metadata("design:paramtypes", [typeorm_1.Repository])
], TransactionQueryService);
//# sourceMappingURL=transactionQuery.service.js.map