...
exports.VehicleTypeModule = VehicleTypeModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([vehicle_type_entity_1.VehicleType, user_entity_1.User]), jwt_auth_module_1.JwtAuthModule],
        controllers: [vehicle_type_controller_1.VehicleTypeController],
        providers: [vehicle_type_service_1.VehicleTypeService],
    })
], VehicleTypeModule);
